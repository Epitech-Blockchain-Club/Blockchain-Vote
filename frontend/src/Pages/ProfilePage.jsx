                        ...
                        <Card className="bg-white border-slate-100 shadow-sm p-8">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="pt-4 flex gap-4">
                                    <Button type="submit" size="lg" className="h-14 px-10 rounded-2xl shadow-lg shadow-primary-500/20">
                                        Enregistrer les modifications
                                    </Button>
                                    <Button type="button" variant="outline" size="lg" className="h-14 px-8 rounded-2xl border-slate-200">
